...
public class HanhKhachDaoImpl implements HanhKhachDao {
    ...
    public HanhKhach getHanhKhachsByTaiKhoanId(String maTaiKhoan){
        ...
        HanhKhach hanhKhach=new HanhKhach();
        try {
            hanhKhach =(HanhKhach) session.createQuery("From HanhKhach hk Where hk.taiKhoanByMaTaiKhoan.maTaiKhoan=:maTaiKhoan")
                    .setParameter("maTaiKhoan", maTaiKhoan).uniqueResult();
        }catch (HibernateException e){
            System.out.println(e);
